package com.andrespusterla.contactossemana2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textDate = (EditText) findViewById(R.id.edtBirthday);
    ...
    public void colocar_fecha() {
        textDate.setText((mDayIni + "/" + (mMonthIni+1) + "/" + mYearIni));
    }
    ...
    public void goCheckData(View view) {
        ...
        miBundle.putString("fullName", fullName);
